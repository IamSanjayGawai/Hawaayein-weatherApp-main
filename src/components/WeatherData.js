    ...
    <div className='weatherData'>
      <div className='currtemp'>
        ...
        <div className='windData'>
            ...
            <p>{props.lang?'Min Temp: ':' किमान  तापमान: '}<span>{Math.round(props.weatherData.temp_min)}&deg;C</span></p>
            <p>{props.lang?'Max Temp: ':'अधिक तापमान: '}<span>{Math.round(props.weatherData.temp_max)}&deg;C</span></p>
        </div>
      </div>
